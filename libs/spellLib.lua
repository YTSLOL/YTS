...
local function SpellLevel(spellSlot)
    ...
    return myHero:GetSpellBook():GetSpellSlotByID(spellSlot):Level()
end
...
SpellLib = {
    ...
    Aatrox = {
        Passive = {
            DmgModHP            = function() return 0.05 + 0.07 / 17 * (myHero:Level() - 1) end,
        ...
        Q1 = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * ({0.60, 0.65, 0.70, 0.75, 0.80})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
        ...
        Q2 = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * ({0.75, 0.8125, 0.875, 0.9375, 1})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q
        },
        Q3 = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * ({0.90, 0.975, 1.05, 1.125, 1.20})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q
        },
        W = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * 0.4 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
        ...
        R = {
            Delay               = function() return 0.25 end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * ({0.2, 0.3, 0.4})[SpellLevel(SpellSlot.R)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
    ...
    Ahri = {
        ...
        Q1 = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.4 end,
        ...
        W1 = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.3 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        W2 = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.48 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.6 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E
        },
        RStack = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.35 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        }
    },
    ...
    Akali = {
        Passive = {
            ...
            Dmg             = function() return ({35, 38, 41, 44, 47, 50, 53, 62, 71, 80, 89, 98, 107, 122, 137, 152, 167, 182})[myHero:Level()] end,
            DmgModAD        = function(self, Target) return Target:BonusAttackDamage() * 0.6 end,
            DmgModAP        = function(self, Target) return Target:TotalAbilityPower() * 0.55 end,
            DamageType      = DamageType.MAGICALDAMAGE,
            SpellSlot       = -1
        },
        Q = {
            ...
            DmgModAD        = function(self, Target) return Target:TotalAttackDamage() * 0.65 end,
            DmgModAP        = function(self, Target) return Target:TotalAbilityPower() * 0.6 end,
            DamageType      = DamageType.MAGICALDAMAGE,
            SpellSlot       = SpellSlot.Q
        },
        ...
        E1 = {
            ...
            DmgModAD        = function(self, Target) return Target:TotalAttackDamage() * 0.255 end,
            DmgModAP        = function(self, Target) return Target:TotalAbilityPower() * 0.36 end,
            DamageType      = DamageType.MAGICALDAMAGE,
            SpellSlot       = SpellSlot.E
        },
        E2 = {
            ...
            DmgModAD        = function(self, Target) return Target:TotalAttackDamage() * 0.595 end,
            DmgModAP        = function(self, Target) return Target:TotalAbilityPower() * 0.84 end,
            DamageType      = DamageType.MAGICALDAMAGE,
            SpellSlot       = SpellSlot.E
        },
        R1 = {
            ...
            DmgModAD        = function(self, Target) return Target:BonusAttackDamage() * 0.5 end,
            DmgModAP        = function(self, Target) return Target:TotalAbilityPower() * 0.3 end,
            DamageType      = DamageType.PHYSICALDAMAGE,
            SpellSlot       = SpellSlot.R
        },
    ...
    Akshan = {
        Passive = {
            ...
            DmgModADBase    = function(self, Target) return Target:TotalAttackDamage() end,
            DamageType      = DamageType.PHYSICALDAMAGE,
            SpellSlot       = -1,
        },
        PassiveStack = {
            Speed           = function() return 5000 end,
            Dmg             = function() return ({10, 15, 20, 25, 30, 35, 40, 45, 55, 65, 75, 85, 95, 105, 120, 135, 150, 165})[myHero:Level()] end,
            DmgModAPBase    = function(self, Target) return Target:TotalAbilityPower() end,
            DamageType      = DamageType.MAGICALDAMAGE,
            SpellSlot       = -1,
        },
        Q = {
            ...
            DmgModAD            = function() return Target:TotalAttackDamage() * 0.8 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        --update
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.175 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        --update
        R = {
            ...
            DmgModADBase        = function() return Target:TotalAttackDamage() end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    Alistar = {
        ...
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.5 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.7 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Amumu = {
        ...
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.85 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.8 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Anivia = {
        ...
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.45 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.2 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.125 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Annie = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.75 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Ashe = {
        Passive = {
            ...
            DmgModADBase        = function(self, Target) return Target:TotalAttackDamage() + Target:BonusAttackDamage() end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            Speed               = function() return math.huge end,
            Delay               = function() return 0 end,
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * ({0.21, 0.22, 0.23, 0.24, 0.25})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * 1 end,
        ...
        R = {
            ...
            Dmg                 = function() return ({200, 400, 600})[SpellLevel(SpellSlot.R)] + (Target:TotalAbilityPower() * 1) end,
            DmgSecondary        = function() return ({100, 200, 300})[SpellLevel(SpellSlot.R)] + (Target:TotalAbilityPower() * 0.5) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            DmgModAPBase        = function(self, Target) return Target:TotalAbilityPower() end,
            SpellSlot           = SpellSlot.R,
        },
    ...
    AurelionSol = {
        Passive = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function() return ({12, 14, 16, 18, 20, 23, 26, 32, 38, 44, 50, 60, 70, 80, 90, 100, 110, 120})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return ({5, 10, 15, 20, 25})[SpellLevel(SpellSlot.W)] + (Target:TotalAbilityPower() * 0.25) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.65 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            Range               = function() return math.huge end,
            Delay               = function() return 0 end,
            Dmg                 = function() return ({16.8, 19.6, 22.4, 25.2, 28, 32.2, 36.4, 44.8, 53.2, 61.6, 70, 84, 98, 112, 126, 140, 154, 168})[myHero:Level()] + (Target:TotalAbilityPower() * 0.35) end,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Blitzcrank = {
        ...
        E = {
            Range               = function() return math.huge end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return Target:BonusAttackDamage() * 1 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Brand = {
        ...
        StackofABlaze3 = {
            Range               = function() return 475 end,
            Dmg                 = function(self, Target) return Target:MaxHealth() / 100 * ({9, 9.25, 9.5, 9.75, 10, 10.25, 10.5, 10.75, 11, 11.25, 11.5, 11.75, 12, 12.25, 12.5, 12.75, 13, 13})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * (0.02 * (Target:TotalAbilityPower() % 100)) end,         
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.25 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Braum = {
        ...
        PassiveStack4 = {
            Dmg                 = function(self, Target) return 16 + 10 * myHero:Level() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
    ...
    Caitlyn = {
        Passive = {
            DmgModAD        = function() 
                if (myHero:Level() == 18) then
                    ...
                    return 0.50 + 0.25 * math.floor(myHero:Level()/6)
                end
            end,
            Range           = function() return 1300 end,
            DmgModADBase      = function(self, Target) return Target:BonusAttackDamage() end,
            DamageType      = DamageType.PHYSICALDAMAGE,
            SpellSlot       = -1,
        ...
        WPassive = {
            ...
            DamageType      = DamageType.PHYSICALDAMAGE,
            Range           = function() return 1300 end,
            DmgModBase      = function(self, Target) return Target:BonusAttackDamage() end,
            SpellSlot       = SpellSlot.W
        },
        E = {
    ...
    Camille = {
        ...
        Q = {
            ...
            Delay               = function() return 0 end,
            Dmg                 = function() return ({75, 125, 175, 225, 275})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return ({20, 25, 30, 35, 40})[SpellLevel(SpellSlot.Q)] + Target:BonusAttackDamage() * 0.4 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            Dmg                 = function() return ({80, 110, 140, 170, 200})[SpellLevel(SpellSlot.E)] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.9 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Cassiopeia = {
        ...
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.9 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            Speed               = function() return 2500 end,
            Dmg                 = function(self, Target) return 48 + 4 * myHero:Level() end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.1 end,
            DmgBonus            = function() return ({20, 40, 60, 80, 100})[SpellLevel(SpellSlot.E)] end,
            DmgBonusModAP       = function(self, Target) return Target:TotalAbilityPower() * 0.6 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Chogath = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 1 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 0.7 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 0.3 end,
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 0.5 end,
    ...
    Corki = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.7 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.15 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R1 = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.15, 0.45, 0.75})[SpellLevel(SpellSlot.R)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.12 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
        R2 = {
        ...
        R3 = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.30, 0.90, 0.150})[SpellLevel(SpellSlot.R)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.24 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Darius = {
        Passive = {
            Dmg                 = function() return ({65, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130, 135, 140, 145, 150})[myHero:Level()] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({1, 1.1, 1.2, 1.3, 1.4})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            Range               = function() return math.huge end,
            Delay               = function() return 0 end,
            Dmg                 = function() return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({1.4, 1.45, 1.5, 1.55, 1.6})[SpellLevel(SpellSlot.W)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.75 end,
            DamageType          = DamageType.TRUEDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Diana = {
        ...
        PassiveStack2 = {
            Dmg                 = function() return ({20, 25, 30, 35, 40, 45, 65, 75, 85, 95, 95, 135, 150, 165, 180, 210, 210, 220})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.5 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
    ...
    Draven = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * ({0.75, 0.85, 0.95, 1.05, 1.15})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * ({1.1, 1.3, 1.5})[SpellLevel(SpellSlot.R)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Ekko = {
        ...
        PassiveStack3 = {
            Dmg                 = function() return ({30, 40, 50, 60, 70, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130, 135, 140})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.8 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 0.4 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
            ...
            Delay               = function() return 0.5 end,
            Dmg                 = function() return ({150, 300, 450})[SpellLevel(SpellSlot.R)] end,
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 1.5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Elise = {
        ...
        PassiveSpiderForm = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.2 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q1 = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * (0.03 * (Target:TotalAbilityPower() % 100)) end,
        ...
        W = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.95 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Evelynn = {
        ...
        Q = {
            ...
            DmgDartModAP        = function(self, Target) return Target:TotalAbilityPower() * 0.3 end,
        ...
        E1 = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * (0.015 % Target:TotalAbilityPower()) end,
            DmgModHP            = function(self, Target) return Target:MaxHealth() / 100 * 3 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        E2 = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function() return ({75, 100, 125, 150, 175})[SpellLevel(SpellSlot.E)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * (0.025 % Target:TotalAbilityPower()) end,
        ...
        R = {
            ...
            Delay               = function() return 0.35 end,
            Dmg                 = function() return ({125, 250, 375})[SpellLevel(SpellSlot.R)] end,
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 0.75 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Ezreal = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.3 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.15 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.6 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * ({0.7, 0.75, 0.8, 0.85, 0.9})[SpellLevel(SpellSlot.W)] end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.9 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    ...
    FiddleSticks = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 2.5 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Fiora = {
        ...
        PassiveVitals = {
            DmgModHP            = function(self, Target) return Target:MaxHealth() / 100 * 3 end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * (0.045 * (Target:BonusAttackDamage() % 100)) end,
            DamageType          = DamageType.TRUEDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * ({0.95, 1, 1.05, 1.1, 1,15})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Fizz = {
        ...
        Q = {
            Range               = function() return 550 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return Target:TotalAbilityPower() + (({10, 25, 40, 55, 70})[SpellLevel(SpellSlot.Q)] + (Target:TotalAbilityPower() * 0.55)) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            Range               = function() return math.huge end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return Target:TotalAbilityPower() + (({50, 70, 90, 110, 130})[SpellLevel(SpellSlot.W)] + (Target:TotalAbilityPower() * 0.5)) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Galio = {
        Passive = {
            Dmg                 = function(self, Target) return 15 + 185 / 17 * (myHero:Level() - 1) end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.5 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
    ...
    Gangplank = {
        Passive = {
            ...
            DmgModADBase        = function(self, Target) return Target:BonusAttackDamage() end,
            Dmg                 = function() return (4.5 + myHero:Level()) * (2.5/0.25) end,
        },
        Q = {
            DamageType          = DamageType.PHYSICALDAMAGE,
            Range               = function() return 625 end,
        ...
        Barrel = {
            DecayTime           = function() 
                if myHero:Level() < 7 then
                    return 2
                elseif myHero:Level() >= 7 and myHero:Level() < 13 then
                    return 1
                else
                    return 0.5
                end
    ...
    Garen = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.32, 0.34, 0.36, 0.38, 0.4})[SpellLevel(SpellSlot.E)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Gnar = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.15 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        Q2 = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.4 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        --update
        ...
        W2 = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Gragas = {
        ...
        W = {
            ...
            DmgModAP            = function(self, Target) return Target:MaxHealth() / 100 * 7 + Target:TotalAbilityPower() * 0.7 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAbilityPower()) * 0.6 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function() return ({200, 300, 400})[SpellLevel(SpellSlot.R)] end,
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 0.8 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Graves = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * ({1.2, 1.5, 1.8, 2.1, 2.4})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Gwen = {
        Passive = {
            ...
            Speed                   = function() return math.huge end,
            Delay                   = function() return 0 end,
            DmgModHP                = function(self, Target) return 0.01 + (math.floor(Target:TotalAbilityPower() / 100) * 0.008) end,
        ...
        R2 = {
            ...
            DmgModAP                = function() return 0.3 end,
            DmgModAPBase            = function(self, Target) return Target:TotalAbilityPower() end,
            DmgModHP                = function(self, Target) return 0.03 + (math.floor(Target:TotalAbilityPower() / 100) * 0.024) end,
            DmgModHPBase            = function(self, Hero) return Hero.MaxHealth end,
        },        
        R3 = {
            DamageType              = DamageType.MAGICALDAMAGE,
            ...
            DmgModAP                = function() return 0.5 end,
            DmgModAPBase            = function(self, Target) return Target:TotalAbilityPower() end,
            DmgModHP                = function(self, Target) return 0.05 + (math.floor(Target:TotalAbilityPower() / 100) * 0.040) end,
            DmgModHPBase            = function(self, Hero) return Hero.MaxHealth end,
        },
    },
    --Modified 08/09/22
    Hecarim = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.95 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Heimerdinger = {
        ...
        W = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.93 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        W2 = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.83 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
        E = {
    ...
    Illaoi = {
        ...
        Q = {
            ...
            -- DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.6 end,
            -- DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            DmgModAP            = function(self, Target) return 8 * ((Target:TotalAttackDamage() + Target:BonusAttackDamage()) % 100) end,
            DamageType          = DamageType.TRUEDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Irelia = {
        Passive = {
            Dmg                 = function(self, Target) return 7 + 3 * myHero:Level() end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.2 end,
            DmgModADBase        = function(self, Target) return Target:TotalAttackDamage() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.6 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.2 end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 1.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
    ...
    Ivern = {
        ...
        W = {
            Range               = function() return 1000 end,
            Delay               = function() return 0.25 end,
            DmgModAP            = function(self, Target) return ({30, 37.5, 45, 52.5, 60})[SpellLevel(SpellSlot.W)] + (Target:TotalAbilityPower() * 0.3) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Janna = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 0.65 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        -- update
    ...
    JarvanIV = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.4 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.8 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Jayce = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        Q2 = {
    ...
    Jhin = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.35, 0.425, 0.5, 0.575, 0.65})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.6 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
    ...
    Jinx = {
        ...
        R = {
            Range               = function() return math.huge end,
            Delay               = function() return 0.6 end,
            Dmg                 = function() return ({250, 400, 550})[SpellLevel(SpellSlot.R)] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.5 + ((Target:MaxHealth() - Target.Health) / 100 * ({25, 30, 35})[SpellLevel(SpellSlot.R)]) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Kalista = {
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.7 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Karma = {
        ...
        Q2 = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({70, 120, 170, 220, 270})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return ({75, 240, 405, 570})[SpellLevel(SpellSlot.R)] + Target:TotalAbilityPower() * 1.3 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Katarina = {
        Passive = {
            Dmg                 = function(self, Target) return ({68, 72, 77, 82, 89, 96, 103, 112, 121, 131, 142, 154, 166, 180, 194, 208, 224, 240})[myHero:Level()] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.6 end,
            --DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * ({0.65, 0.65, 0.65, 0.65, 0.65, 0.75, 0.75, 0.75, 0.75, 0.75, 0.85, 0.85, 0.85, 0.85, 0.85, 0.95}) end,
            --DmgModAPBase        = function(self, Target) return Target:TotalAbilityPower() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.4 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.25 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 2.7 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 2.85 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    Kayle = {
        Passive = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.1 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.25 end,
            DamageType          = DamageType.MAGICALDAMAGE,
        },
        Q = {
        ...
        E = {
            Range               = function() return 350 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({15, 20, 25, 30, 35})[SpellLevel(SpellSlot.E)] + ((Target:MaxHealth() - Target.Health) / 100 * (({8, 9, 10, 11, 12})[SpellLevel(SpellSlot.E)] * 0.02 + (Target:TotalAbilityPower() % 100))) end,
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 0.1 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.2 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
    ...
    Kayn = {
        --update
        Passive = {
            Dmg                 = function(self, Target) return 0.08 + 0.22 / 17 * (myHero:Level() - 1) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.3 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.75 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
        R2 = {
    ...
    Kennen = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.6875 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    KhaZix = {
        Passive = {
            Dmg                 = function(self, Target) return 8 + 6 * myHero:Level() end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.4 end,
            DmgModADBase        = function(self, Target) return Target:TotalAttackDamage() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({60, 85, 110, 135, 160})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.15 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 0.2 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Kled = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.95 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        -- update
        ...
        E = {
            ...
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({70, 120, 170, 220, 270})[SpellLevel(SpellSlot.E)] end,
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 1.3 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
            ...
            DmgModAD            = function(self, Target) return (12 * (Target:BonusAttackDamage() % 100)) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    KogMaw = {
        Passive = {
            Dmg                     = function() return 100 + 25 * myHero:Level() end,
            DamageType              = DamageType.TRUEDAMAGE,
        ...
        W = {
            Delay                   = function() return 0 end,
            DmgModHP                = function(self, Target) return ({0.035, 0.0425, 0.05, 0.0575, 0.065})[SpellLevel(SpellSlot.W)] + math.floor(Target:TotalAbilityPower()/100) end,
            DmgModHPBase            = function(self, Hero) return Hero.MaxHealth end,
            DamageType              = DamageType.MAGICALDAMAGE,
        ...
        R = {
            ...
            DmgModADBase            = function(self, Target) if Target ~= nil then return Target:BonusAttackDamage() else return 0 end end,
            DmgModAP                = function() return 0.35 end,
            DmgModAPBase            = function(self, Target) if Target ~= nil then return Target:TotalAbilityPower() else return 0 end end,
            DmgModHP                = function(self, Target) 
    ...
    LeeSin = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 1 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Leona = {
        Passive = {
            Dmg                 = function() return 24 + 8 * myHero:Level() end,
            DmgModAPBase        = function(self, Target) return Target:TotalAbilityPower() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
    ...
    Lillia = {
        ...
        W = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.05 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Lissandra = {
        --update
        Passive = {
            --Dmg                 = function(self, Target) return ({120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 370, 400, 430, 460, 490, 520})[SpellLevel(-1)] end,
            --DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.5 end,
            --DmgModAPBase        = function(self, Target) return Target:TotalAbilityPower() end,
            --DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
    ...
    Lucian = {
        ...
        Q = {
            Range               = function() return 500 end,
            Delay               = function() return 0.4 - 0.15 / 17 * (myHero:Level() - 1) end,
            Dmg                 = function(self, Target) return ({95, 125, 155, 185, 215})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * ({0.6, 0.75, 0.9, 1.05, 1.2})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.25 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.15 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    ...
    Lulu = {
        -- update
        Passive = {
            Dmg                 = function(self, Target) return 9 + 6 * myHero:Level() end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.15 end,
            DmgModAPBase        = function(self, Target) return Target:TotalAbilityPower() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
    ...
    Lux = {
        Passive = {
            Dmg                 = function(self, Target) return 10 + 10 * myHero:Level() end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.2 end,
            DmgModAPBase        = function(self, Target) return Target:TotalAbilityPower() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
    ...
    Malzahar = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.8 end,
            DmgModHP            = function(self, Target) return Target:MaxHealth() / 100 * (({10, 15, 20})[SpellLevel(SpellSlot.R)] + (2.5 * (Target:TotalAbilityPower() % 100))) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Maokai = {
        ...
        E = {
            Range               = function() return 1100 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({55, 80, 105, 130, 120})[SpellLevel(SpellSlot.E)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.425 end,
    ...
    MasterYi = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.875 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 0.35 end,
            DamageType          = DamageType.TRUEDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    MissFortune = {
        ...
        R = {
            ...
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({10.50, 12.00, 13.50})[SpellLevel(SpellSlot.R)] end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * ({2.8, 3.2, 3.6})[SpellLevel(SpellSlot.R)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    Mordekaiser = {
        ...
        Q = {
            Range               = function() return 625 end,
            Delay               = function() return 0.5 end,
            Dmg                 = function(self, Target) return ({5, 9, 13, 17, 21, 25, 29, 33, 37, 41, 51, 61, 71, 81, 91, 107, 123, 139})[myHero:Level()] + ({75, 95, 115, 135, 155})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.6 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
    ...
    Morgana = {
        ...
        W = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.89 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.4 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Nasus = {
        ...
        R = {
            ...
            Dmg                 = function(self, Target) return Target:MaxHealth() / 100 * ({45, 60, 75})[SpellLevel(SpellSlot.R)] + (15 * (Target:TotalAbilityPower() % 100)) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    Nautilus = {
        -- updated 17/08/22
        Passive = {
            Dmg                 = function(self, Target) return 2 + 6 * myHero:Level() end,
            DmgModADBase        = function(self, Target) return Target:TotalAttackDamage() end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
    ...
    Neeko = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.3 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    Nidalee = {
        ...
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.5 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Nilah = {
        ...
        R2 = {
            ...
            DmgModAD           = function(self, Target) return Target:BonusAttackDamage() * 2.6 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    ...
    Nocturne = {
        Passive = {
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * 1.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.85 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Nunu = {
        Passive = {
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * 0.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
        --update
    ...
    Orianna = {
        Passive = {
            Dmg                 = function() return 10 + 8 * (1 + (math.floor(myHero:Level()-1 / 3))) end,
            DmgModAP            = function() return 0.15 end,
            DmgModAPBase        = function(self, Target) return Target:TotalAbilityPower() end,
            DamageType          = DamageType.MAGICALDAMAGE,
        },
        PassiveStack = {
            Dmg                 = function() return (14 + 11.2 * (1 + (math.floor(myHero:Level()-1 / 3)))) end,
    ...
    Ornn = {
        ...
        Q = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({20, 45, 70, 95, 120})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.1 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Pantheon = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 2.3 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Poppy = {
        Passive = {
            Dmg                 = function(self, Target) return 20 + 160 / 17 * (myHero:Level() - 1) end,
            DmgModAPBase        = function(self, Target) return Target:TotalAbilityPower() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
    ...
    Pyke = {
        ...
        R = {
            Range               = function() return 750 end,
            Delay               = function() return 0.5 end,
            Dmg                 = function(self, Target) return ({0, 0, 0, 0, 0, 250, 290, 330, 370, 400, 430, 450, 470, 490, 510, 530, 540, 550})[myHero:Level()] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.8 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Qiyana = {
        Passive = {
            Dmg                 = function(self, Target) return 11 + 4 * myHero:Level() end,
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 0.3 end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 0.3 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
        ...
        R = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({100, 200, 300})[SpellLevel(SpellSlot.R)] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.7 end,
            DmgModHP            = function(self, Target) return Target:MaxHealth() / 100 * 10 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    ...
    Quinn = {
        --update
        Passive = {
            Dmg                 = function(self, Target) return 5 + 5 * myHero:Level() end,
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 0.14 + (0.02 * myHero:Level()) end,
            DmgModADBase        = function(self, Target) return Target:BonusAttackDamage() end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
        ...
        Q = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({20, 45, 70, 95, 120})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.8, 0.9, 1, 1.1, 1.2})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        --update
        R = {
            Range               = function() return 700 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.4 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Rell = {
        --update
        Passive = {
            Dmg                 = function(self, Target) return 8 + 8 * (myHero:Level() - 1) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.1 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Renekton = {
        ...
        Q2 = {
            ...
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({100, 150, 200, 250, 300})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 1.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        W2 = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 2.25 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Rengar = {
        ...
        Q = {
            ...
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({30, 60, 90, 120, 150})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0, 0.05, 0.1, 0.15, 0.2})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        Q2 = {
            Range               = function() return math.huge end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({30, 45, 60, 75, 90, 105, 120, 135, 145, 155, 165, 175, 185, 195, 205, 215, 225, 235})[myHero:Level()] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.4 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        ...
        W2 = {
            Range               = function() return 450 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.8 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        ...
        E2 = {
            Range               = function() return 1000 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 245, 260, 275, 290, 305})[myHero:Level()] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.8 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
    ...
    Riven = {
        --update
        Passive = {
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * ({0.3, 0.3, 0.3, 0.3, 0.3, 0.36, 0.36, 0.36, 0.42, 0.42, 0.42, 0.48, 0.48, 0.48, 0.54, 0.54, 0.54, 0.6})[myHero:Level()] end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({1.35, 1.5, 1.65, 1.8, 1.95})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Rumble = {
        --update
        Passive = {
            Dmg                 = function(self, Target) return 5 + 35 / 17 * (myHero:Level() - 1) end,
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower()* 0.25 end,
            DmgModHP            = function(self, Target) return Target:MaxHealth() / 100 * 6 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        ...
        Q2 = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.65 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.75 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Samira = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.85, 0.95, 1.05, 1.15, 1.25})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            ...
            Delay               = function() return 0.1 end,
            Dmg                 = function(self, Target) return ({20, 35, 50, 65, 80})[SpellLevel(SpellSlot.W)] end,
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 0.8 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    Sejuaini = {
        ...
        E = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({55, 105, 155, 205, 255})[SpellLevel(SpellSlot.E)] end,
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 0.6 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        --update
    ...
    Senna = {
        ...
        W = {
            ...
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 0.7 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Seraphine = {
        --update
        Passive = {
            Dmg                 = function() return ({4, 4, 4, 4, 4, 8, 8, 8, 8, 8, 14, 14, 14, 14, 14, 24, 24, 24})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.07 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * ({0.45, 0.5, 0.55, 0.6, 0.65})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Sett = {
        --update
        Passive = {
            Dmg                 = function(self, Target) return 5 * myHero:Level() end,
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 0.5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:MaxHealth() / 100 * (2 + (({2, 3, 4, 5, 6})[SpellLevel(SpellSlot.Q)]) * (Target:TotalAttackDamage() + Target:BonusAttackDamage() % 100)) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            ...
            DmgModAD            = function(self, Target) return 25 + (25 * (Target:BonusAttackDamage() % 100)) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Shaco = {
        --update
        Passive = {
            Dmg                 = function(self, Target) return 20 + 15 / 17 * (myHero:Level() - 1) end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.25 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
        ...
        W = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAbilityPower() * 0.12 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        --update
    ...
    Shen = {
        ...
        Q = {
            Range               = function() return math.huge end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({30,30,30,48,48,48,66,66,66,84,84,84,102,102,102,120,120,120})[myHero:Level()] end,
            DmgModHP            = function(self, Target) return Target:MaxHealth() / 100 * ({15, 16.5, 18, 19.5, 21})[SpellLevel(SpellSlot.Q)] + (6 * (Target:TotalAbilityPower() % 100)) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Shyvana = {
        ...
        Q = {
            Range               = function() return math.huge end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.2, 0.35, 0.5, 0.65, 0.8})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.25 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        ...
        W = {
            ...
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({20, 32.5, 45, 57.5, 70})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.2 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        ...
        E = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({60, 100, 140, 180, 220})[SpellLevel(SpellSlot.E)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.3 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.7 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        E2 = {
            ...
            Dmg                 = function(self, Target) return ({0,0,0,0,0,100, 105, 110, 115, 120, 125, 130, 135, 140, 145, 150, 155, 160})[myHero:Level()] + ({60, 100, 140, 180, 220})[SpellLevel(SpellSlot.E)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.6 end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
    ...
    Sion = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({1.35, 1.575, 1.8, 2.025, 2.25})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Sivir = {
        ...
        Q = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({30, 60, 90, 120, 150})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({1.6, 1.7, 1.8, 1.9, 2})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        ...
        W = {
            Range               = function() return math.huge end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.25, 0.3, 0.35, 0.40, 0.45})[SpellLevel(SpellSlot.W)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Skarner = {
        ...
        Q = {
            Range               = function() return 350 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return Target:MaxHealth() / 100 * ({1, 1.5, 2, 2.5, 3})[SpellLevel(SpellSlot.Q)] + ((Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.2) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        Q2 = {
            Range               = function() return 350 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return Target:MaxHealth() / 100 * ({2, 3, 4, 5, 6})[SpellLevel(SpellSlot.Q)] + (((Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.2) + (Target:TotalAbilityPower() * 0.3)) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Sona = {
        ...
        Q = {
            Range               = function() return 825 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({40, 70, 100, 130, 160})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.4 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
    ...
    Swain = {
        ...
        R = {
            Range               = function() return 650 end,
            Delay               = function() return 0.5 end,
            Dmg                 = function(self, Target) return (({420, 600, 780})[SpellLevel(SpellSlot.R)] + (Target:TotalAbilityPower() * 1.7)) + (({200, 300, 400})[SpellLevel(SpellSlot.R)]) + (Target:TotalAbilityPower() * 1) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Syndra = {
        ...
        Q2 = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.8125 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            Range               = function() return 700 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({85, 130, 175, 220, 265})[SpellLevel(SpellSlot.E)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.6 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        ...
        R = {
            Range               = function() return 675 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({630, 980, 1330})[SpellLevel(SpellSlot.R)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.4 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    ...
    TahmKench = {
        Passive = {
            Dmg                 = function(self, Target) return 8 + 52 / 17 * (myHero:Level() - 1) end,
        ...
        Q = {
            Range               = function() return 900 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({80, 130, 180, 230, 280})[SpellLevel(SpellSlot.Q)] + (Target:TotalAbilityPower() * 0.7) end,
            DmgModAP            = function(self, Target) return 8 + 52 / 17 * (myHero:Level() - 1) end,
            DmgModHP            = function(self, Target) return (Target.Health) / 100 * 3 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        ...
        R = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({100, 250, 400})[SpellLevel(SpellSlot.R)] end,
            DmgModHP            = function(self, Target) return Target:MaxHealth() / 100 * (15 + 5 * (Target:TotalAbilityPower() % 100)) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Taliyah = {
        ...
        Q = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.35 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Talon = {
        Passive = {
            --Dmg                 = function(self, Target) return 65 + 10 * myHero:Level() end,
            --DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 2 end,
            --DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1,
        },
    ...
    Taric = {
        Passive = {
            Dmg                 = function(self, Target) return 21 + 4 * myHero:Level() end,
    ...
    Thresh = {
        ...
        E = {
            ...
            Delay               = function() return 0.3889 end,
            Dmg                 = function(self, Target) return ({65, 95, 125, 155, 185})[SpellLevel(SpellSlot.E)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.4 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
    ...
    Tristana = {
        Passive = {
            Dmg                 = function() return 8 + 8 * myHero:Level() end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1
        },
        Q = { 
        ...
        E1 = {
            Range               = function() return 517 + 8 * myHero:Level() end,
    ...
    Trundle = {
        ...
        Q = {
            ...
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({20, 40, 60, 80, 100})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.15, 0.25, 0.35, 0.45, 0.55})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        R = {
            Range               = function() return 650 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return Target:MaxHealth() / 100 * (({20, 27.5, 35})[SpellLevel(SpellSlot.R)] + 2 * (Target:TotalAbilityPower() % 100)) end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    ...
    Twitch = {
        PassiveStack = {
            Dmg             = function() 
                return 1 + math.floor(myHero:Level()/4)
            end,
        ...
        EStack2 = {
            DmgModAPBase    = function(self, Target) return Target:TotalAbilityPower() end,
            DmgModAP        = function() return 0.33 end,
            DamageType      = DamageType.MAGICALDAMAGE,
        },
        R = {
    ...
    Udyr = {
        ...
        Q = {
            Range               = function() return 450 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return Target:MaxHealth() / 100 * ({6, 8.8, 11.6, 14.4, 17.2, 20})[SpellLevel(SpellSlot.Q)] + 12 * (Target:BonusAttackDamage() % 100) end,
            DmgModAD            = function(self, Target) return ({5, 13, 21, 29, 37, 45})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD2           = function(self, Target) return Target:BonusAttackDamage() * 0.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.6 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    Urgot = {
        ...
        W = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.2, 0.235, 0.27, 0.305, 0.34})[SpellLevel(SpellSlot.W)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return Target:BonusAttackDamage() * 0.5 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Varus = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.8333, 0.8667, 0.9, 0.9333, 0.9667})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            Range               = function(self, Target) return Target.AttackRange end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return Target:MaxHealth() / 100 * (({9, 10.5, 12, 13.5, 15})[SpellLevel(SpellSlot.W)] + 7.5 * (Target:TotalAbilityPower() % 100)) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Vayne = {
        ...
        Q = {
            Range               = function() return 300 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.60, 0.65, 0.70, 0.75, 0.80})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
        ...
        E = {
            ...
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 1.25 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Velkoz = {
        --update
        Passive = {
            Dmg                 = function() return 25 + 8 * myHero:Level() end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 0.5 end,
            DamageType          = DamageType.TRUEDAMAGE,
            SpellSlot           = -1,
        },
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 1.25 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Vex = {
        Passive = {
            Dmg                 = function() return 30 + 110 / 17 * (myHero:Level() -  1) end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 0.2 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        ...
        E = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({50, 70, 90, 110, 130})[SpellLevel(SpellSlot.E)] end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * ({0.4, 0.45, 0.5, 0.55, 0.6})[SpellLevel(SpellSlot.E)] end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Vi = {
        ...
        W = {
            Range               = function(self, Target) return Target.AttackRange end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return Target:MaxHealth() / 100 * (({4, 5.5, 7, 8.5, 10})[SpellLevel(SpellSlot.W)] + 1 * (Target:BonusAttackDamage() % 35)) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return (Target:BonusAttackDamage()) * 1.1 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Viego = {
        ...
        R = {
            Range               = function() return 500 end,
            Delay               = function() return 0.5 end,
            Dmg                 = function(self, Target) return (Target:MaxHealth() - Target.Health) / 100 * (({12, 16, 20})[SpellLevel(SpellSlot.R)] + 3 * (Target:BonusAttackDamage() % 100)) end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    Viktor = {
        ...
        R = {
            ...
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 3.2 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Vladimir = {
        ...
        Q2 = {
            ...
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 1.11 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
    ...
    Volibear = {
        Passive = {
            Dmg                 = function() return ({11, 12, 13, 15, 17, 19, 22, 25, 28, 31, 34, 37, 40, 44, 48, 52, 56, 60})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 0.4 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        ...
        R = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({300, 500, 700})[SpellLevel(SpellSlot.R)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 2.5 end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 1.25 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    ...
    Warwick = {
        Passive = {
            Dmg                 = function() return 10 + 2 * myHero:Level() end,
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 0.15 end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 0.1 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = -1
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 1.67 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    MonkeyKing = {
        ...
        Q = {
            ...
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return ({20, 45, 70, 95, 120})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return (Target:BonusAttackDamage()) * 0.45 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            Range               = function() return 300 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * ({0.35, 0.4, 0.45, 0.5, 0.55})[SpellLevel(SpellSlot.W)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 4.4 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Xerath = {
        ...
        W = {
            ...
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 1.0002 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAbilityPower()) * ({1.35, 1.8, 2.25})[SpellLevel(SpellSlot.R)] end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Yasuo = {
        ...
        Q = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({20, 45, 70, 95, 120})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.05 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        Q3 = {
    ...
    Yone = {
        ...
        Q = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({20, 40, 60, 80, 100})[SpellLevel(SpellSlot.Q)] end,
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 1.05 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        Q3 = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.8 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Zac = {
        ...
        W = {
            ...
            DmgModHP            = function(self, Target) return Target:MaxHealth() / 100 * ({4, 5, 6, 7, 8})[SpellLevel(SpellSlot.W)] + 4 * (Target:TotalAbilityPower() % 100) end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
    ...
    Zed = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 1.1 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
            ...
            DmgModAD            = function(self, Target) return Target:BonusAttackDamage() * 0.66 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.W,
        },
        E = {
        ...
        R = {
            Range               = function() return 625 end,
            Delay               = function() return 0 end,
            Dmg                 = function(self, Target) return (Target:TotalAttackDamage() + Target:BonusAttackDamage()) * 0.65 + ({25, 40, 55})[SpellLevel(SpellSlot.R)] end,
            SpellSlot           = SpellSlot.R,
        },
    },
    Zeri = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target:TotalAttackDamage() * ({1, 1.05, 1.1, 1.15, 1.2})[SpellLevel(SpellSlot.Q)] end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Ziggs = {
        Passive = {
            Dmg                 = function() return ({20, 24, 28, 32, 36, 40, 48, 56, 64, 72, 80, 88, 100, 112, 124, 136, 148, 160})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 0.5 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            Range               = function() return 1400 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({85, 135, 185, 235, 285})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 0.65 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
    ...
    Zoe = {
        Passive = {
            Dmg                 = function() return ({16, 20, 24, 28, 32, 36, 42, 48, 54, 60, 66, 74, 82, 90, 100, 11, 120, 130})[myHero:Level()] end,
            DmgModAP            = function(self, Target) return (Target:TotalAbilityPower()) * 0.2 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = -1,
        },
        Q = {
            Range               = function() return 1600 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({17.5, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 72.5, 80, 87.5, 95, 105, 115, 125})[myHero:Level()] + ({125, 200, 275, 350, 425})[SpellLevel(SpellSlot.Q)] end,
            DmgModAP            = function(self, Target) return Target:TotalAbilityPower() * 1.5 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
    ...
    --         Range               = function() return 700 end,
    --         Delay               = function() return 0.125 end,
    --         Dmg                 = function() return 48 + 4 * myHero:Level() end,
    ...
    --     PassiveStack = {
    --         DamageType          = DamageType.MAGICALDAMAGE,
    --         Dmg                 = function() return (10 + 8 * (1 + (math.floor(myHero:Level()-1 / 3)))) * 0.2 end,
